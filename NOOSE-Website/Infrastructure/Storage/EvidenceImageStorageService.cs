...
/// <inheritdoc />
public class EvidenceImageStorageService : IEvidenceImageStorageService
{
    private readonly FileUploadOptions _options;
    private readonly string _basePath;

    public EvidenceImageStorageService(IWebHostEnvironment env, IOptions<FileUploadOptions> options)
    {
        _options = options.Value;
        _basePath = Path.IsPathRooted(_options.AsservatePath)
            ? _options.AsservatePath
            : Path.Combine(env.ContentRootPath, _options.AsservatePath);
    }
