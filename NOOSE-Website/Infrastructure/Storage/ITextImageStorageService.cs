...
/// <summary>Storage for images pasted into text fields; own base path, so its endpoint can never reach a file photo.</summary>
public interface ITextImageStorageService
{
    long MaxBytes { get; }
