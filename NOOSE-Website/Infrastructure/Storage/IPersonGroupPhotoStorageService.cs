...
/// <summary>Person-group photo storage outside wwwroot; server-assigned file names, read/delete accept bare names only (path-traversal guard).</summary>
public interface IPersonGroupPhotoStorageService
{
    long MaxBytes { get; }
