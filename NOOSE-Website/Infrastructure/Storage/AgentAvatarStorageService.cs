...
/// <inheritdoc />
public class AgentAvatarStorageService : IAgentAvatarStorageService
{
    private readonly FileUploadOptions _options;
    private readonly string _basePath;

    public AgentAvatarStorageService(IWebHostEnvironment env, IOptions<FileUploadOptions> options)
    {
    ...
    public long MaxBytes => _options.AvatarMaxBytes;
