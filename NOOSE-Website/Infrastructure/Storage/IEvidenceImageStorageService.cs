...
/// <summary>Evidence-item image storage outside wwwroot; server-assigned file names, read/delete accept bare names only (path-traversal guard).</summary>
public interface IEvidenceImageStorageService
{
    long MaxBytes { get; }
