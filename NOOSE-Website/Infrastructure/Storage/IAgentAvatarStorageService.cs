...
/// <summary>Stores agent profile pictures outside wwwroot; server-assigned file names, read/delete accept bare names only (path-traversal guard).</summary>
public interface IAgentAvatarStorageService
{
    long MaxBytes { get; }
