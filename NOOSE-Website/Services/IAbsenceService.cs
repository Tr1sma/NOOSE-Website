...
public interface IAbsenceService
{
    ...
    Task<List<AbsenceRow>> GetListAsync(bool mayAll, string? meId, DateOnly? from = null, DateOnly? to = null,
        CancellationToken cancellationToken = default);

    Task<Absence?> GetDetailAsync(string id, bool mayAll, string? meId, CancellationToken cancellationToken = default);
