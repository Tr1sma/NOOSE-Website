...
/// ausschliesslich ueber Discord-OAuth; ein Passwort wird nie gesetzt.
/// </summary>
public class Agent : IdentityUser
{
    ...
    /// <summary>Numerische Discord-Benutzer-ID (stabiler externer Schluessel, eindeutig).</summary>
    public string DiscordId { get; set; } = string.Empty;

    /// <summary>Discord-Benutzername (z. B. "name" bzw. altes "name#1234"), rein informativ.</summary>
    public string? DiscordUsername { get; set; }

    /// <summary>URL zum Discord-Avatar (optional, fuer die Anzeige).</summary>
    ...
    /// <summary>Tactical Response Unit: ranguebergreifendes Flag (jeder Rang kann rein).</summary>
    public bool IstTRU { get; set; }

    /// <summary>Technische Systemrolle (Auftraggeber). Unabhaengig vom Dienstgrad.</summary>
    ...
    /// <summary>Begruendung der letzten Sperrung (fuer Audit/Anzeige).</summary>
