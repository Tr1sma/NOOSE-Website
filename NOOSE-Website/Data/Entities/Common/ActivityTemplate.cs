...
/// <summary>An activity template: a predefined HTML body copied into the editor on new-activity creation; leadership-managed.</summary>
[Table("AktivitaetVorlagen")]
public class ActivityTemplate : IAuditable, ISoftDelete
{
